...
def build_cvae_encoder(ssdna_input_shape, molecule_input_shape, latent_dim):
    ...
    ssdna_x = layers.Dense(32, activation='relu')(ssdna_x)  
    ssdna_x = layers.Dense(16, activation='relu')(ssdna_x)  

    molecule_x = layers.Dense(128, activation='relu')(molecule_inputs)
    molecule_x = layers.Dense(64, activation='relu')(molecule_x)
    molecule_x = layers.Dense(32, activation='relu')(molecule_x)  
    molecule_x = layers.Dense(16, activation='relu')(molecule_x)  
...
# cVAE Decoder
# cVAE Decoder with L2 regularization
...
cvae.compile(optimizer=optimizer, metrics=metrics)
...
# # Accessing the history to monitor metrics
